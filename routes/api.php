...
Route::prefix('admin/variants')->group(function () {
    ...
    Route::put('/update/{id}', [VariantController::class, 'update']);
    Route::delete('/{productId}', [VariantController::class, 'deleteAllVariants']);
    Route::delete('/{variantId}/values/{valueId}', [VariantController::class, 'destroyValue']);
    Route::delete('/{id}/variant/{variantId}', [VariantController::class, 'destroyvariant']);
});
